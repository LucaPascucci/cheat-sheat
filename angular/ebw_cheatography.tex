...
\pdfinfo{
  /Title (EBWCheatSheet.pdf)
  /Creator (Luca Pascucci)
  /Author (Luca Pascucci (lucapascucci))
  /Subject (EBW Cheat Sheet)
}
...
\begin{tabulary}{5.8cm}{C}
    ...
    {\parbox{\dimexpr\textwidth-2\fboxsep\relax}{\noindent
        \hspace*{-6pt}\includegraphics[width=5.8cm]{./images/EBWorld.png}}
    }
\end{tabulary}
\columnbreak
\begin{tabulary}{11cm}{L}
    \vspace{-2pt}\large{\bf{\textcolor{DarkBackground}{\textrm{EBW Cheat Sheet}}}} \\
...
\begin{tabulary}{5.8cm}{LL}
  ...
  \uline{cheatography.com/lucapascucci} \\
  \end{tabulary}
\vfill
\columnbreak
...
\begin{multicols*}{3}
   ...
   \begin{tabularx}{5.377cm}{X}
      \SetRowColor{DarkBackground}
      \mymulticolumn{1}{x{5.377cm}}{\bf\textcolor{white}{Configurazione Progetto generico}}  \tn

      \SetRowColor{LightBackground}
      \mymulticolumn{1}{x{5.377cm}}{\textbf{Config EDITOR -> root del progetto}} \tn

      \SetRowColor{white}
      \mymulticolumn{1}{x{5.377cm}}{Copiare file \textbf{.editorconfig}} \tn

      \SetRowColor{LightBackground}
      \mymulticolumn{1}{x{5.377cm}}{\textbf{Plugins}
  ...
  \begin{tabularx}{5.377cm}{x{1.74195 cm} x{3.23505 cm}}
    \SetRowColor{DarkBackground}
    \mymulticolumn{2}{x{5.377cm}}{\bf\textcolor{white}{Angular}}  \tn
    \SetRowColor{LightBackground}
    Componenti \& Servizi & UpperCamelCase \tn
    \SetRowColor{white}
    Observer \& Subjects & lowerCamelCase\$ \tn
    \SetRowColor{LightBackground}
    Funzioni: & lowerCamelCase \tn
    \SetRowColor{white}
    Variabili: & lowerCamelCase \tn
    \SetRowColor{LightBackground}
    Costanti: & UPPER\_CASE \tn
    \hhline{>{\arrayrulecolor{DarkBackground}}--}
  \end{tabularx}
  \par\addvspace{1em}
  ...
  \begin{tabularx}{5.377cm}{X}
   \SetRowColor{DarkBackground}
   \mymulticolumn{1}{x{5.377cm}}{\bf\textcolor{white}{Lint Typescript}}  \tn
   \SetRowColor{LightBackground}
   \mymulticolumn{1}{x{5.377cm}}{\textbf{Installazione}} \tn
   \SetRowColor{white}
   \mymulticolumn{1}{x{5.377cm}}{Automaticamente presente nei progetti Angular} \tn
   \SetRowColor{LightBackground}
   \mymulticolumn{1}{x{5.377cm}}{\textbf{Configurazioni -> root del progetto}} \tn
   \SetRowColor{white}
   \mymulticolumn{1}{x{5.377cm}}{Copiare \textbf{tslint.json}} \tn
   \hhline{>{\arrayrulecolor{DarkBackground}}-}
   \end{tabularx}
   \par\addvspace{1em}
