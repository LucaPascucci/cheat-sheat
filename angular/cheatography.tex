...
\begin{multicols*}{2}
   ...
   \begin{tabularx}{8.5cm}{X}
      ...
      \href{https://github.com/editorconfig/editorconfig-notepad-plus-plus}{Nodepad++}
      \tn

      \SetRowColor{LightBackground}
      Copiare il file \href{https://drive.google.com/open?id=1fqdzQ_g0pRYIZGzjyJdR29E4__NuP7dK}{\textbf{.gitignore}} nella root del progetto \tn

      \hhline{>{\arrayrulecolor{DarkBackground}}-}
   \end{tabularx}
   \par\addvspace{1em}

   \begin{tabularx}{8cm}{x{5cm} x{3cm}}
      \SetRowColor{DarkBackground}
      \mymulticolumn{2}{x{8cm}}{\bf\textcolor{white}{Naming}} \tn
   ...
   \begin{tabularx}{8.5cm}{X}
      \SetRowColor{DarkBackground}
      \bf\textcolor{white}{TSLint (Aiuta durante la stesura del codice)} \tn
   ...
   \begin{tabularx}{8.5cm}{X}
      ...
      \SetRowColor{white}
      npm install \texttt{-{}-}save-dev @compodoc/compodoc \tn
