...
\pdfinfo{
  /Title (Cheat_Sheet_Angular.pdf)
  /Creator (Luca Pascucci)
  /Author (Luca Pascucci (lucapascucci))
  /Subject (Cheat_Sheet_Angular)
}
...
\begin{tabulary}{5.8cm}{C}
    ...
    {\parbox{\dimexpr\textwidth-2\fboxsep\relax}{\noindent
        \includegraphics[height=55px]{./images/angular.png}}
    }
\end{tabulary}
\columnbreak
\begin{tabulary}{11cm}{L}
    \vspace{-2pt}\large{\bf{\textcolor{DarkBackground}{\textrm{Cheat Sheet Angular}}}} \\
